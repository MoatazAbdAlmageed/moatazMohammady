...
export const kids = [{ name: 'Hamza' }, { name: 'Belal' }];

export const skills: SkillCategory[] = [
  {
    title: 'Front-end',
    skills: [
      { title: 'HTML', icon: 'html5', url: 'https://en.wikipedia.org/wiki/HTML' },
      { title: 'CSS', icon: 'css3-alt', url: 'https://en.wikipedia.org/wiki/CSS' },
      { title: 'Sass', icon: 'sass', url: 'https://sass-lang.com/#' },
      { title: 'Javascript', icon: 'js-square', url: 'https://www.javascript.com/' },
      { title: 'Typescript', icon: 'ts', url: 'https://www.typescriptlang.org/' },
      { title: 'ReactJS', icon: 'react', url: 'https://reactjs.org/' },
    ],
  },
  {
    title: 'Back-end',
    skills: [
      { title: 'NodeJS', icon: 'node-js', url: 'https://nodejs.org/en/' },
      { title: 'PHP', icon: 'php', url: 'https://www.php.net/' },
      { title: 'Laravel', icon: 'laravel', url: 'https://laravel.com/' },
    ],
  },
  {
    title: 'Database',
    skills: [
      { title: 'MySQL', icon: 'database fa', url: 'https://www.mysql.com/' },
      { title: 'MongoDB', icon: 'database fa', url: 'https://www.mongodb.com/' },
    ],
  },
  {
    title: 'Other',
    skills: [
      { title: 'Wordpress', icon: 'wordpress', url: 'https://wordpress.org/' },
      { title: 'Gatsby', icon: 'rocket fa', url: 'https://www.gatsbyjs.org/' },
      { title: 'GraphQL', icon: 'graphql fa', url: 'https://graphql.org/' },
      { title: 'ElectronJS', icon: 'desktop fa', url: 'https://www.electronjs.org/' },
      { title: 'Linux', icon: 'linux', url: 'https://www.linux.org/' },
      { title: 'Git', icon: 'git', url: 'https://git-scm.com/' },
      { title: 'Photoshop', icon: 'adobe', url: 'https://www.adobe.com/mena_en/products/photoshopfamily.html' },
    ],
  },
];
...
export const interests: Interest[] = [
  {
    ...
    title: 'Blogging',
    sites: [
      { url: 'https://moatazworld.wordpress.com/', title: 'moatazworld' },
      { url: 'https://caramellaapp.com/moatazmohammady', title: 'caramellaapp' },
      { url: 'https://dev.to/moatazabdalmageed', title: 'dev.to' },
    ],
  },
  {
...
export const socialLinks: Record<string, SocialLink> = {
  github: { icon: 'fa-github', name: 'Github', url: 'https://github.com/MoatazAbdAlmageed', show: true },
  linkedin: { icon: 'fa-linkedin', url: 'https://www.linkedin.com/in/moatazabdelmageed', show: true },
  stackoverflow: { icon: 'fa-stack-overflow', url: 'https://stackoverflow.com/users/2524043/moataz-mohammady', show: false },
  codepen: { icon: 'fa-codepen', url: 'https://codepen.io/Moataz-Mohammady/pens/public' },
  edabit: { icon: 'fa-trophy', name: 'edabitK', url: 'https://edabit.com/user/NcL6egjCcAi5zR9k2', show: false },
  behance: { icon: 'fa-behance', url: 'https://www.behance.net/moatazmohammady', show: true },
  wordpress: { icon: 'fa-wordpress', url: 'https://profiles.wordpress.org/moataz-mohammady/', show: false },
  goodreads: { icon: 'fa-book', url: 'https://www.goodreads.com/user/show/92723087-moataz-mohammady', show: false },
  caramellaapp: { icon: 'fas fa-tint', url: 'https://caramellaapp.com/moatazmohammady', show: false },
  youtube: { icon: 'fa-youtube', url: 'https://www.youtube.com/@moatazMohamady', show: false },
  upwork: { icon: 'fa-upwork', url: 'https://www.upwork.com/freelancers/~014cb5bb210055661c', show: false },
};
...
export const certifications: Certification[] = [
  {
    ...
    description: 'This certificate above verifies that Moataz Mohammady successfully completed the course Introduction to TypeScript on 07/26/2021',
  ...
  },
  {
    ...
    description: 'This course helped you develop your use of English in a range of everyday situations and built your confidence by improving your listening skills.',
...
export const jobs: Job[] = [
  {
    ...
    technologies: ['WordPress', 'Elementor', 'PHP', 'MySQL', 'WooCommerce', 'HTML', 'CSS', 'JavaScript'],
    ...
    projects: [
      { name: 'QAED Website', url: 'https://theqaed.com/', technologies: ['WordPress', 'Elementor', 'PHP', 'MySQL'] },
      { name: 'QAED Website for certificates', url: 'https://ql-me.com/', technologies: ['WordPress', 'Elementor', 'PHP', 'MySQL', 'ACF'] },
    ],
  },
  {
    company: 'Wuilt',
    ...
    url: 'http://wuilt.com/',
    technologies: ['HTML', 'CSS', 'Javascript', 'typescript', 'react', 'PHP', 'mysql', 'Laravel', 'wordPress', 'graphql', 'nodejs', 'mongodb'],
    ...
    description: '',
    projects: [
      { name: 'Wuilt blog', url: 'https://wuilt.com/blog/ar/', technologies: ['WordPress'] },
      { name: 'Wuilt Builder', url: 'https://app.wuilt.com/', technologies: ['PHP', 'Laravel', 'reactJS'] },
      { name: 'Wuilt Store', url: 'http://store.wuilt.com/', technologies: ['nodeJS', 'mondoDB', 'graphql', 'reactJS'] },
    ],
  },
  {
    company: 'camelCase',
    ...
    description: '',
    projects: [
      { name: 'skilledmatrix.com', url: 'http://skilledmatrix.com/', technologies: ['PHP', 'Laravel'] },
      { name: 'skillsbuilderpro.com', url: 'http://skillsbuilderpro.com/', technologies: ['PHP', 'Zend'] },
      { name: 'knowledgeworkerspro.com', url: 'http://knowledgeworkerspro.com/', technologies: ['PHP', 'Zend'] },
    ],
  },
  {
    company: 'Nile Bits',
    ...
    description: '',
    projects: [
      { name: 'netscribe', url: 'https://viqsolutions.com/solutions/netscribe/', technologies: ['angularjs'] },
    ],
  },
  {
    company: 'TIE',
    ...
    url: 'http://tie.com.eg/',
    technologies: ['HTML', 'CSS', 'Javascript', 'PHP', 'mysql', 'Laravel', 'angularjs'],
    startDate: dayjs('2016-08-01'),
    ...
    description: '',
    projects: [
      { name: 'la creation', url: 'https://www.instagram.com/la__creation/', technologies: ['PHP', 'Wordpress'] },
    ],
  },
  {
    company: 'EgyCoders',
    ...
    description: '',
    projects: [
      { name: 'hotel reservation project', url: '#', technologies: ['angularjs'] },
    ],
  },
  {
    company: 'Orchtech',
    ...
    description: '',
    projects: [
      { name: 'sevensprings.ch', url: 'https://sevensprings.ch/', technologies: ['PHP', 'Wordpress'] },
      { name: 'shapwasco.com', url: 'http://shapwasco.com.eg', technologies: ['PHP', 'Wordpress'] },
      { name: 'uacciap.org', url: 'http://uacciap.org', technologies: ['PHP', 'Wordpress'] },
    ],
  },
  {
    company: 'Leogami',
    ...
    description: '',
    projects: [
      { name: 'contraplanii', url: 'http://www.contraplanii.com', technologies: ['wordpress'] },
      { name: 'https://fiestaegypt.com/', url: 'http://www.fiestaegypt.com', technologies: ['wordpress'] },
    ],
  },
];

export const siteTitle = 'Moataz Mohammady | Senior PHP & Laravel Developer | Node.js & WordPress Specialist';
export const description = 'Senior Backend Developer. Specialist in PHP, Laravel, WordPress, Node.js and familiar with JS frontend frameworks. Skilled in MySQL, MongoDB, and third-party integrations. Proficient in authentication, security, and familiar with HTML, CSS, JavaScript, React, and Angular for effective front-end collaboration. Also familiar with basic DevOps practices such as Docker, server setup, and CI/CD pipelines.';
export const manifestName = 'Resume';
export const manifestShortName = 'Moataz Mohammady';
export const manifestStartUrl = 'https://moatazabdalmageed.github.io/';
export const manifestBackgroundColor = '#1D3D59';
export const manifestThemeColor = '#FE6F42';
export const manifestDisplay = 'standalone';
export const manifestIcon = 'src/assets/img/avatar.png';
export const pathPrefix = '/';
export const firstName = 'Moataz';
export const lastName = 'Mohammady';
export const githubUsername = 'MoatazAbdAlmageed';
export const position = 'Senior PHP & Laravel Developer | Node.js & WordPress Specialist';
export const site_img = 'https://avatars2.githubusercontent.com/u/17373050?s=460&u=b26d5f5d825283b7b067e10a46add610b512cb26&v=4';
export const keywords = 'developer,web,code,programming,html,css,js,react,php,mysql,docker,nodejs,mongodb';
export const TRACKING_ID = '';
export const GITHUB_TOKEN = '';
export const FORMSPREE = 'xgenoded';
...
export const email = 'moataz.mohammady@gmail.com';
export const whatsapp = 'https://wa.me/201150064746';
export const phone = '+201150064746';
export const phone2 = '+201067869404';
export const address = 'Mansouria,Giza,Egypt';
export const location = 'https://goo.gl/maps/QHh4H4eYJMByuneC8';
export const REACT_APP_SITE_KEY = '6Lep6c0iAAAAAKc4uMszguapnASF0Yi0gdRm9ZGi';
